	...
	return (
		<MainLayout mainMenu={mainMenu} footerMenu={footerMenu} basicSettings={basicSettings}>
			<div className='container-xxl'>
				<MainPageSlider />
				<h1 className='page-heading page-heading_h1  page-heading_m-h1'>Magasin</h1>
				<ProductsList
					products={products}
				...
				columns={[
					{
						...
						comment: 'Provande composé à la base de produits agricole bio .'
					},
					{
						icon:  <FontAwesomeIcon icon={faShieldAlt} className={'text-with-icons__icon'} />,
						title: 'Riche en calorie, vitamines...etc',
						comment: 'Bon pour la santé des consommateur.'
					},
					{
						icon:  <FontAwesomeIcon icon={faSmile} className={'text-with-icons__icon'} />,
						title: 'Looks nice',
						comment: 'Riche en calorie, vitamines...etc.'
					},
				]}
				fullWidth={true}
				className={'page-block'}
			...
			<div className='container-xxl'>
				<ProductsSliderByQuery
					...
					title={'Offers speciale :'}
					wrapperClassName='page-block'
				/>
				<div className={'page-block'}>
					<h2 className={'text-center mb-4'}>Ils en parlent</h2>
					<Reviews
						reviews={[
							{
	...
	const slides = [
		{
			...
			'link': '',
			'caption': 'La source idéale de protéines et de vitamines!',
		...
		},
		{
			...
			'link': '',
			'caption': 'Nos poules sont élevées en liberté et sont nourries d\'aliments naturels et sains.',
			'captionPosition': 'bottom',
			'useFilling': true,
			'fillingColor': '#000000',
			'fillingOpacity': 0.4
