		...
		<>
			<div className='cart-items'>
				<div className='cart-items__thead row'>
					...
					<div className='cart-items__thead-cell col-md-2'>Prix</div>
				...
				<div className='cart-items__total-row row'>
					<div className='cart-items__total-cell cart-items__total-cell_title col-md-6'>Commande Total:</div>
					<div className='cart-items__total-cell col-md-2'>
						<span className='cart-items__label'>Qty: </span>
						{total.qty}
					</div>
					<div className='cart-items__total-cell col-md-2'>
						<span className='cart-items__label'>Prix: </span>
						{total.price}
					</div>
				</div>
			</div>
			<div className='cart-items__actions'>
				...
				>
					Valider <FontAwesomeIcon icon={faShoppingCart} />
				</button>
			</div>
		</>
	);
